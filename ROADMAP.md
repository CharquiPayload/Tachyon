...
- **Surviving and fighting.**
  - Gear: it picks the best weapon, puts on armor and eats.
  - Combat: it uses bows with real aim and hunts the way a player does.
  - Items: it keeps trash and toss lists.
  - Death: it records each death, goes back for the items it dropped, and
    sends notices to its owner.
  - Reflexes: it defends itself, handles creepers and archers, breathes,
    stays afloat, eats when hungry and digs out when buried.
